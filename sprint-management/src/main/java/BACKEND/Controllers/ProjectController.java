...
public class ProjectController {
     ...
     */
    public boolean update(int id, Project updatedProject) {
        Session session = sessionFactory.openSession();
        Transaction transaction = null;
     ...
     */
    public boolean update(int projectId, String newName, String newDescription) {
        Session session = sessionFactory.openSession();
        Transaction transaction = null;
        boolean updated = false;
    ...
    /**
     * Updates the project currently selected by this object.
     *
     * @return true if the project was updated successfully, false otherwise.
     */
