...
public class UserApiController {
	...
	public UserApiController(SessionFactory sessionFactory) {
		this.sessionFactory = sessionFactory;
		this.userController = new UserController(sessionFactory);

		InputStream inputStream = UserApiController.class.getClassLoader().getResourceAsStream("logging.properties");
		try {
